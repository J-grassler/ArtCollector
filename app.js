...
const KEY = 'apikey=e414e7cf-4ac4-49dd-93aa-fedceb138881';
...
function buildSearchString() {
  ...
  const centure = $('#select-century').val()
  const keyWords = $('#keywords').val()
  const url = `${BASE_URL}/object?${KEY}&classification=${classify}&century=${centure}&keyword=${keyWords}`;
  return url;
};
